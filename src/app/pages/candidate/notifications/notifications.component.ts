...
@Component({
    ...
    <div class="notifications-page">
      <div class="page-header">
        <div class="header-content">
          ...
          <p class="page-subtitle">Stay updated with your job applications and profile views</p>
        </div>
      ...
      <ng-template #emptyState>
        <div class="empty-state">
          ...
          <button mat-flat-button color="primary" routerLink="/candidate/dashboard" class="mt-4">
            Back to Dashboard
          </button>
        </div>
      </ng-template>
  ...
  styles: [`
    ...
    .notification-icon.profile { background: #f3e5f5; color: #9c27b0; }
    .notification-icon.system { background: #fff3e0; color: #fb8c00; }
    .notification-icon.security { background: #ffebee; color: #e53935; }
...
export class NotificationsComponent implements OnInit {
  ...
  getIcon(type: string): string {
    switch (type) {
      ...
      case 'APPLICATION_STATUS_CHANGED': return 'work';
      case 'INTERVIEW_SCHEDULED':
      case 'INTERVIEW_CONFIRMED':
      case 'INTERVIEW_RESCHEDULED':
      case 'INTERVIEW_CANCELLED': return 'event';
      case 'PROFILE_VIEWED': return 'visibility';
